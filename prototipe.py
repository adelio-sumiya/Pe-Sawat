...
def tampilkan_riwayat():
    ...
    print("-"*100)
    for row in riwayat:
        print(f"{row['Tanggal']:<12}{row['Nama']:<15}{'Departure':<15}{'Arrival':<15}{row['Airlines']:<15}{row['Waktu']:<20}{row['Jumlah_Penumpang']:<10}Rp {int(row['Total_Harga']):,}<15}}{row['Metode_Pembayaran']:<15}")
    print("-"*100)
    input("\nTekan Enter untuk kembali ke menu...")
